        ...
        <article className="flex flex-col gap-12 justify-start">
            ...
            <div className="flex gap-12">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="83" height="110" viewBox="0 0 83 110" fill="none">
                    <path
                        d="M2.12012 31.3682C6.32602 28.8652 76.995 -13.2038 80.173 7.7708C84.1226 33.838 75.4555 57.6974 63.1103 79.8336C60.8747 83.8422 50.6856 108.15 59.2984 108.15"
                        stroke="black" strokeWidth="3" strokeLinecap="round"/>
                </svg>
            </div>
            <div className="flex gap-6">
