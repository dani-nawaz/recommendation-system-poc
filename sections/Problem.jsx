...
export function EvaluatorCard({name, title, src}) {
    return (
        <div
            className="bg-gray-50 p-6 rounded flexflex-wrap items-center justify-between sm:flex-nowrap w-[300px] md:w-full">
...
export default function Problem() {
    ...
    return (
        <article className="flex flex-col gap-6 sm:gap-12 justify-start overflow-hidden">
